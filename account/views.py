...
def send_activation_mail(user):
    ...
    send_mail('Активация аккаунта', f'Вы успешно зарегистрировались. Пожалуйста автивируйте свой аккаунт. Для этого пройдите по ссылке http://127.0.0.1:8000/accounts/activate/{code}/',
              'test@test.com',
              [user.email, ])
